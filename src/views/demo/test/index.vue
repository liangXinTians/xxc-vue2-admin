  ...
  <div class="all">
    ...
    <div class="top">
      <el-row class="top-left">
        <el-button plain size="small" @click="addAddress"><i class="el-icon-plus"></i> 新增</el-button>
        <el-button plain size="small" @click="exportData"><i class="el-icon-download"></i> 导出</el-button>
      </el-row>
      <div class="top-right">
        <div class="flex fen">
          <div class="fen-text">收货人</div>
          <el-input v-model="search.userName" placeholder="请输入收货人" size="medium"></el-input>
        </div>
        <div class="flex fen">
          <div class="fen-text">手机号</div>
          <el-input v-model="search.phone" placeholder="请输入手机号" size="medium"></el-input>
        </div>
        <el-form :inline="true" :model="short" class="demo-form-inline form" size="mini">
          <el-form-item>
    ...
    <div class="content">
      <el-table highlight-current-row class="lable" ref="multipleTable" :data="filteredData.length > 0 ? filteredData : tableData" tooltip-effect="dark"
        style="width: 100%">
    ...
    <!-- 分页 -->
    <div class="bottom">
      <el-pagination background @size-change="handleSizeChange(10)" @current-change="handleCurrentChange(1)"
         :page-sizes="[10, 20, 50, 100]" :page-size="100"
    ...
    <el-form :model="newAddressForm" ref="newAddressForm" label-width="80px">
      <el-form-item label="收货人" prop="userName" placeholder="请输入收货人" :rules="[{ required: true, message: '请输入收货人' }]">
        <el-input v-model="newAddressForm.userName"></el-input>
      </el-form-item>
      <el-form-item label="手机号" prop="phone" placeholder="请输入手机号" :rules="[{ required: true, message: '请输入手机号' }]">
        <el-input v-model="newAddressForm.phone"></el-input>
      </el-form-item>
      <el-form-item label="地址" prop="address" placeholder="请输入地址" :rules="[{ required: true, message: '请输入地址' }]">
        <el-input v-model="newAddressForm.address"></el-input>
      </el-form-item>
      <el-form-item label="默认地址" prop="isDefault" :rules="[{ required: true, message: '请选择是否为默认地址' }]">
        <el-radio-group v-model="newAddressForm.isDefault">
          <el-radio label="true">是</el-radio>
          <el-radio label="false">否</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="是否启用" prop="normalDisable" :rules="[{ required: true, message: '请选择是否启用' }]">
      ...
      <el-form-item label="备注">
        <el-input v-model="newAddressForm.remark"></el-input>
      </el-form-item>
    </el-form>
